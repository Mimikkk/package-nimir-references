...
export class ReferenceCache<TResource> {
  private constructor(private readonly cache: Cache<ResourceEntry<TResource>>) {}

  static new<TResource>(cache: Cache<ResourceEntry<TResource>>): ReferenceCache<TResource> {
